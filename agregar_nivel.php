...
if (isset($_POST['agregar'])) {
	...
	$fecha_final = $_POST['fecha_inicio'];
	...
	$sql = "INSERT INTO nivel (cod_nivel,trimestre,ci_lider,cantidad_estudiantes,fech_inicio,fech_final,estatus_nivel,horario) VALUES ('','$nivel','$ci_lider','0','$fecha_inicio','$fecha_final','Abierto','$horario')";
