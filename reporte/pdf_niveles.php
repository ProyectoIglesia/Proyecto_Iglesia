...
$pdf->Cell(26, 8, 'Cedula lider', 1);
$pdf->Cell(20, 8, 'Nivel', 1);
$pdf->Cell(20, 8, 'estudiantes', 1);
$pdf->Cell(30, 8, 'Fecha inicio', 1);
$pdf->Cell(35, 8, 'Fecha final', 1);
$pdf->Cell(35, 8, 'Estatus', 1);
$pdf->Cell(28, 8, 'Horario', 1);
$pdf->Ln(8);
$pdf->SetFont('Arial', '', 8);
//CONSULTA
